...
import { Menu, X, Calendar, Users, Trophy, Swords, LogOut, User, ChevronDown, Search, MessageCircle, Shield, Target } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-gray-900 text-lg hidden sm:block">PadelClub</span>
          </Link>
              ...
              <div className="relative">
                ...
                {userMenuOpen && (
                  <>
                    ...
                    <div className="absolute right-0 top-full mt-1.5 w-52 bg-white rounded-xl shadow-lg border border-gray-100 py-1 z-20">
          ...
          {navLinks.map(({ href, label, icon: Icon }) => (
            <Link
              ...
              className={cn(
                ...
                pathname === href ? "bg-green-50 text-padel-green" : "text-gray-700 hover:bg-gray-50"
              )}
            >
