...
export default function AdminDashboard() {
  ...
  const cards = [
    { label: "Players", value: stats?.players, icon: Users, href: "/admin/players", color: "text-blue-600 bg-blue-50" },
    { label: "Matches", value: stats?.matches, icon: Swords, href: "/matches", color: "text-green-600 bg-green-50" },
    { label: "Tournaments", value: stats?.tournaments, icon: Trophy, href: "/admin/tournaments", color: "text-amber-600 bg-amber-50" },
    { label: "Open Games", value: stats?.openGames, icon: Gamepad2, href: "/open-games", color: "text-purple-600 bg-purple-50" },
  ];
          ...
          <Card className="p-4 flex items-center justify-between hover:shadow-md transition-shadow cursor-pointer">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Create, edit, register teams</p>
              </div>
            </div>
          ...
          <Card className="p-4 flex items-center justify-between hover:shadow-md transition-shadow cursor-pointer">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">View and edit player ELO</p>
              </div>
            </div>
            <ChevronRight className="w-4 h-4 text-gray-400" />
          </Card>
